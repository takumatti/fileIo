...
public class ExcelExportService {
	 ...
	 * @return ダミーデータ情報リスト
	 */
	public List<ExcelExportDto> createDummyList() {

		List<ExcelExportDto> list = new ArrayList<>();

		ExcelExportDto dto1 = new ExcelExportDto();
		dto1.setId(1);
		dto1.setName("山田太郎");
		dto1.setActive(true);
		...
		ExcelExportDto dto2 = new ExcelExportDto();
		dto2.setId(2);
		...
		ExcelExportDto dto3 = new ExcelExportDto();
		dto3.setId(3);
	 ...
	 * @param	ダミーデータ情報
	 */
	public List<ExcelExportDto> createAndUpdate() {

		List<ExcelExportDto> list = createDummyList();
	 ...
	 */
	public void exportSingleExcel(List<ExcelExportDto> list,
	 ...
	 * @throws Exception	例外情報
	 */
	public void exportMultiSheetExcel(List<ExcelExportDto> list,
			HttpServletResponse response) throws Exception {
	 ...
	 * @throws Exception	例外情報
	 */
	public void exportMultiExcelZip(List<ExcelExportDto> list,
			HttpServletResponse response) throws Exception {
