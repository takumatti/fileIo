...
import io.common.enums.CsvFileMode;
import io.common.enums.CsvMultiOutputMode;
...
public class CsvExportController {
	 ...
	 * HTMLテンプレートパス
	 */
	private static final String LIST_HTML_TEMPLATE_FILE_PATH = "csv/csvExport";
	...
	public String update(@RequestParam String encoding, @RequestParam QuoteMode quoteMode,
		...
		List<CsvExportDto> list = csvSampleService.createAndUpdate();
		...
		return "redirect:/csvExport/result";
	}
